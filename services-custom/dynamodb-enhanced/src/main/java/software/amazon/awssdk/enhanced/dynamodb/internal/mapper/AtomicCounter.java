...
public final class AtomicCounter {
    public static final String CUSTOM_METADATA_KEY_PREFIX = "AtomicCounter:";

    private static final String DELTA_ATTRIBUTE_NAME = CUSTOM_METADATA_KEY_PREFIX + "Delta";
    private static final String STARTVALUE_ATTRIBUTE_NAME = CUSTOM_METADATA_KEY_PREFIX + "Startvalue";
    ...
    public static class CounterAttribute {
        ...
        public AttributeValue resolvedValue() {
