 ...
 * By default, the counter will start on 1 (incrementing from 0) and increment with 1 for each subsequent calls to updateItem.
...
public @interface DynamoDbAtomicCounter {
    ...
    /**
     * The starting value of the counter. Observe that the first written value will be +1 for an increasing counter
     * and -1 for a decreasing, thus a default value will see '1' when the attribute is first written.
     */
